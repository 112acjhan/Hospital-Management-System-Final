...
#define OPTLISTSIZE 256  
         ...
         */
        snprintf(optlist, OPTLISTSIZE, "boxsize={%d %d} position={right top} fitmethod=clip",
            bw, bh);
        ...
        snprintf(optlist, OPTLISTSIZE,
            ...
            bw, bh);
        PDF_fit_image(p, image, x, y-=yoffset, optlist);
         ...
         * or width completely fits into the box.
         */
        snprintf(optlist, OPTLISTSIZE, "boxsize={%d %d} fitmethod=entire", bw, bh);
        PDF_fit_image(p, image, x, y-=yoffset, optlist);
